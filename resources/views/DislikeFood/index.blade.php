...
<body>
  ...
  <a href="{{ route('DislikeFood.show', $DislikeFood->id) }}" class="show mr-3">
      <i class="fa-sharp fa-solid fa-eye" style="color:#36304A;" data-toggle="tooltip"
          title="檢視"></i></a>
...
<form id="del_icon" action="{{ route('DislikeFood.destroy', $DislikeFood->id) }}"  method="post" style="display: inline-block;">
 @csrf @method('DELETE')
